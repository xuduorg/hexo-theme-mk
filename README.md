...
![alt text](https://img.shields.io/badge/Hexo-%3E%3D%205.0-blue?logo=hexo)


![alt text](https://img.shields.io/badge/license-MIT-green)


![alt text](https://img.shields.io/badge/Comment-Waline-brightgreen)
...
在线演示: 点击查看演示站点 (请替换为你的链接)

原版主题: mkBlog (WordPress)
...
content_copy
expand_less
git clone https://github.com/你的用户名/hexo-theme-mk.git themes/hexo-theme-mk
2. 安装必要插件
...
设置页面 Layout：编辑 source/shuoshuo/index.md，设置 layout: page-shuoshuo。
...
创建页面：hexo new page "links"，设置 layout: page-links。

添加数据：在博客根目录创建 source/_data/links.yml，格式如下：
...
致谢: 本主题的原型设计与灵感来源于 Meng Kun 开发的 WordPress 版 mkBlog 主题。
